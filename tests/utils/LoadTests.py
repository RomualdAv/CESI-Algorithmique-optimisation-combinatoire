...
class TestChargement(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.box2 = Box(id=uuid.uuid4(), weight=300, volume=1500, box_type='normal')
        self.box3 = Box(id=uuid.uuid4(), weight=150, volume=500, box_type='fragile')
        self.box4 = Box(id=uuid.uuid4(), weight=400, volume=1200, box_type='normal')
    ...
    def test_should_return_remaining_capacity(self):
        """Teste la capacité restante après le chargement de boîtes."""
